...
class dA(object):
    ...
    def __init__(self, numpy_rng, weight_reg = None, sparsity = None,
                 sp_penalty = None, theano_rng=None, input=None, n_visible=None, n_hidden=None,
                 W=None, bhid=None, bvis=None, sentence_length = None ):
        """
    ...
    def get_hidden_values(self, input):
        ...
        #result1 =  T.nnet.sigmoid(T.dot(input, self.W) + self.b)
    ...
    def get_reconstructed_input(self, hidden):
        ...
        """
        #result2 =  T.nnet.sigmoid(T.dot(hidden, self.W_prime) + self.b_prime)
